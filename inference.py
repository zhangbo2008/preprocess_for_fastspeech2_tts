...
def main(args):
    ...
    args.checkpoint_path='/home/troila/zhangbo/checkpoint_model_150k_steps.pyt'
    args.out='output'
    args.text="ModuleList can be indexed like a regular Python list but modules it contains are properly registered."
...
def get_parser():
    ...
    # task related
    parser.add_argument(
        "--text", type=str, required=False, help="Filename of train label data (json)"
    )
    parser.add_argument(
