# 官网地址 :  https://github.com/tugstugi/pytorch-dc-tts/issues

# groundtruth aligned (GTA) outputs
#     https://keithito.com/LJ-Speech-Dataset/

#2022-03-17,15点12  学习英语tts的原理.
...
def main(cmd_args):
    ...
    )  # load the vocoder for validation  这个模型输入mel 返回audio
